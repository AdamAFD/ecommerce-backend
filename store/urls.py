...
urlpatterns = [
    ...
    path('product/update/<int:id>',views.UpdateProductViewSet.as_view()),
    path('product/update/',views.UpdateProductViewSet.as_view()),
    path('product/add',views.AddProductViewSet.as_view()),
    path('product/delete/<int:id>',views.DeleteProductViewSet.as_view()),
    ...
    # path('orderitem',views.MakeOrderViewSet.as_view())
]
